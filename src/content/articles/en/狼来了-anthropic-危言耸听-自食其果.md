---
title: "Cry Wolf: Anthropic's Alarmism Comes Home to Roost"
description: "Anthropic pulled Fable 5 and Mythos 5 globally after three days—export controls it couldn't operationalize. Years of existential AI rhetoric met the same national-security logic turned inward."
pubDate: 2026-07-05
category: insights
articleSlug: "狼来了-anthropic-危言耸听-自食其果"
locale: en
draft: false
---
## Key Takeaways
...
- Same period, plenty of **applause** in public discourse: those tired of AI "doom narratives" saw the company that **shouted threat loudest** **bitten** by the same **national security** rhetoric—a fable fulfilled.
...
Models launched **June 9**—lived **three days**.
Official reason: export control order banning **any foreign national** from use—including people in the US and Anthropic's own foreign employees. Company said it couldn't **verify nationality in real time** across hundreds of millions of users—**pulled for everyone**.
Same period, plenty of **applause**: those tired of AI "doom narratives" saw the company that **shouted threat loudest** **bitten** by the same **national security** rhetoric—a **fable fulfilled**.
Whether to applaud is debatable. One causal chain is **quite clear** in public facts—
...
**Fact one: Supported regions list.** Anthropic publishes [Supported countries and regions](https://www.anthropic.com/supported-countries): **mainland China and Hong Kong not listed**. Claude.ai and commercial API **not officially open** to these regions.
**Fact two: Hong Kong IP blocked directly.** Multiple tech outlets and local industry analysis: Hong Kong **not** blocked by local government—**Anthropic actively** rejects by IP; claude.ai shows **region unavailable**. Anthropic told **Financial Times**: Claude **never** **officially supported** in Hong Kong—**Reuters** April 2026 relayed Goldman tightening compliance, **canceling Hong Kong IB staff** Claude access.
...
**June 12**, foreigners can't use → engineering **can't close only foreigners** → **nobody can use globally**.
...
Appeals court **April** denial cited Amodei saying "vast majority of customers unaffected"—**extreme rhetoric** in **court** **less lethal** than one **damage-minimizing** line.
...
While **mainland China, Hong Kong users** **lack even qualification to be woken**—**off the support list**.
...
Fable 5 delisted **three days**—**Opus remains**.
...
A: "Cry Wolf: Anthropic's Alarmism Comes Home to Roost"—background, events, author's view.

**Crying Wolf to the Max—key points?**

A: See that section; not investment or legal advice.

**For Mainland China and Hong Kong Users—key points?**

A: See that section; not investment or legal advice.

**Reaping What You Sow—key points?**

A: See that section; not investment or legal advice.

**A Closed System—key points?**
